...
mrpt_msgs__msg__GenericObject__init(mrpt_msgs__msg__GenericObject * msg)
{
  ...
  if (!rosidl_runtime_c__uint8__Sequence__init(&msg->data, 0)) {
    mrpt_msgs__msg__GenericObject__fini(msg);
    return false;
  }
  return true;
}
...
mrpt_msgs__msg__GenericObject__create()
{
  ...
  mrpt_msgs__msg__GenericObject * msg = (mrpt_msgs__msg__GenericObject *)allocator.allocate(sizeof(mrpt_msgs__msg__GenericObject), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mrpt_msgs__msg__GenericObject));
  bool success = mrpt_msgs__msg__GenericObject__init(msg);
  if (!success) {
...
mrpt_msgs__msg__GenericObject__Sequence__init(mrpt_msgs__msg__GenericObject__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mrpt_msgs__msg__GenericObject * data = NULL;

  if (size) {
    data = (mrpt_msgs__msg__GenericObject *)allocator.zero_allocate(size, sizeof(mrpt_msgs__msg__GenericObject), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mrpt_msgs__msg__GenericObject__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        mrpt_msgs__msg__GenericObject__fini(&data[i - 1]);
      }
...
mrpt_msgs__msg__GenericObject__Sequence__fini(mrpt_msgs__msg__GenericObject__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      mrpt_msgs__msg__GenericObject__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mrpt_msgs__msg__GenericObject__Sequence * array = (mrpt_msgs__msg__GenericObject__Sequence *)allocator.allocate(sizeof(mrpt_msgs__msg__GenericObject__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mrpt_msgs__msg__GenericObject__Sequence__init(array, size);
  if (!success) {
...
mrpt_msgs__msg__GenericObject__Sequence__destroy(mrpt_msgs__msg__GenericObject__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mrpt_msgs__msg__GenericObject__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mrpt_msgs__msg__GenericObject__Sequence__are_equal(const mrpt_msgs__msg__GenericObject__Sequence * lhs, const mrpt_msgs__msg__GenericObject__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mrpt_msgs__msg__GenericObject__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mrpt_msgs__msg__GenericObject__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mrpt_msgs__msg__GenericObject);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mrpt_msgs__msg__GenericObject * data =
      (mrpt_msgs__msg__GenericObject *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mrpt_msgs__msg__GenericObject__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mrpt_msgs__msg__GenericObject__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!mrpt_msgs__msg__GenericObject__copy(
