...
#ifndef MRPT_MSGS__MSG__DETAIL__OBSERVATION_RANGE_BEARING__STRUCT_H_
#define MRPT_MSGS__MSG__DETAIL__OBSERVATION_RANGE_BEARING__STRUCT_H_
...
/// Struct defined in msg/ObservationRangeBearing in the package mrpt_msgs.
/**
 ...
 */
typedef struct mrpt_msgs__msg__ObservationRangeBearing
{
  ...
  mrpt_msgs__msg__SingleRangeBearingObservation__Sequence sensed_data;
} mrpt_msgs__msg__ObservationRangeBearing;

// Struct for a sequence of mrpt_msgs__msg__ObservationRangeBearing.
typedef struct mrpt_msgs__msg__ObservationRangeBearing__Sequence
{
...
#endif  // MRPT_MSGS__MSG__DETAIL__OBSERVATION_RANGE_BEARING__STRUCT_H_
