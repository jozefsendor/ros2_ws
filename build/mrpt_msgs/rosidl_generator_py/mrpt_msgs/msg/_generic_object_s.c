...
bool mrpt_msgs__msg__generic_object__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mrpt_msgs.msg._generic_object.GenericObject", full_classname_dest, 43) == 0);
  }
  mrpt_msgs__msg__GenericObject * ros_message = _ros_message;
  {  // data
...
{
  /* NOTE(esteve): Call constructor of GenericObject */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mrpt_msgs.msg._generic_object");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GenericObject");
