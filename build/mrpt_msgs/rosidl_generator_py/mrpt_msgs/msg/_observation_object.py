...
class Metaclass_ObservationObject(type):
    """Metaclass of message 'ObservationObject'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'mrpt_msgs.msg.ObservationObject')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__observation_object
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__observation_object
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__observation_object
            cls._TYPE_SUPPORT = module.type_support_msg__msg__observation_object
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__observation_object

            from geometry_msgs.msg import Pose
            if Pose.__class__._TYPE_SUPPORT is None:
                Pose.__class__.__import_type_support__()

            from mrpt_msgs.msg import SingleObjectObservation
            if SingleObjectObservation.__class__._TYPE_SUPPORT is None:
                SingleObjectObservation.__class__.__import_type_support__()
...
class ObservationObject(metaclass=Metaclass_ObservationObject):
    """Message class 'ObservationObject'."""
    ...
    _fields_and_field_types = {
        ...
        'sensed_data': 'sequence<mrpt_msgs/SingleObjectObservation>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BasicType('double'),  # noqa: E501
        rosidl_parser.definition.BasicType('double'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['mrpt_msgs', 'msg'], 'SingleObjectObservation')),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, SingleObjectObservation) for v in value) and
                 True), \
                "The 'sensed_data' field must be a set or sequence and each value of type 'SingleObjectObservation'"
