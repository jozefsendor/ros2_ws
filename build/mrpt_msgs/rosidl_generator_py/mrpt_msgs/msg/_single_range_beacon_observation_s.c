...
bool mrpt_msgs__msg__single_range_beacon_observation__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mrpt_msgs.msg._single_range_beacon_observation.SingleRangeBeaconObservation", full_classname_dest, 75) == 0);
  }
  mrpt_msgs__msg__SingleRangeBeaconObservation * ros_message = _ros_message;
  {  // range
...
{
  /* NOTE(esteve): Call constructor of SingleRangeBeaconObservation */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mrpt_msgs.msg._single_range_beacon_observation");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SingleRangeBeaconObservation");
