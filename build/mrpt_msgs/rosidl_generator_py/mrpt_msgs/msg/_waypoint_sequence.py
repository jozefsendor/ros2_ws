...
class Metaclass_WaypointSequence(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from mrpt_msgs.msg import Waypoint
...
class WaypointSequence(metaclass=Metaclass_WaypointSequence):
    ...
    _fields_and_field_types = {
        ...
        'waypoints': 'sequence<mrpt_msgs/Waypoint>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['mrpt_msgs', 'msg'], 'Waypoint')),  # noqa: E501
    )
