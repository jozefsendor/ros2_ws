...
#include "mrpt_msgs/msg/detail/waypoint_sequence__rosidl_typesupport_fastrtps_c.h"
...
#include "mrpt_msgs/msg/detail/waypoint__functions.h"  // waypoints
...
using _WaypointSequence__ros_msg_type = mrpt_msgs__msg__WaypointSequence;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: waypoints
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, mrpt_msgs, msg, Waypoint
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: waypoints
  {
    ...
    if (ros_message->waypoints.data) {
      mrpt_msgs__msg__Waypoint__Sequence__fini(&ros_message->waypoints);
    }
  ...
  size_t current_alignment)
{
  ...
  // field.name waypoints
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_mrpt_msgs__msg__Waypoint(
...
static uint32_t _WaypointSequence__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mrpt_msgs__msg__WaypointSequence(
  ...
  size_t current_alignment)
{
  ...
  // member: waypoints
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_mrpt_msgs__msg__Waypoint(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = mrpt_msgs__msg__WaypointSequence;
    is_plain =
      (
...
static size_t _WaypointSequence__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mrpt_msgs__msg__WaypointSequence(
