...
#include "mrpt_msgs/msg/detail/network_of_poses__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const mrpt_msgs::msg::NodeIDWithPoseVec &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  mrpt_msgs::msg::NodeIDWithPoseVec &);
...
{
bool cdr_serialize(
  const mrpt_msgs::msg::GraphConstraint &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const mrpt_msgs::msg::NetworkOfPoses & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mrpt_msgs::msg::NetworkOfPoses & ros_message)
{
  // Member: root
  cdr >> ros_message.root;
  ...
  size_t current_alignment)
{
  ...
  // Member: nodes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mrpt_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_NodeIDWithPoseVec(
  ...
  // Member: constraints
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mrpt_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_GraphConstraint(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = mrpt_msgs::msg::NetworkOfPoses;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mrpt_msgs::msg::NetworkOfPoses *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mrpt_msgs::msg::NetworkOfPoses *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _NetworkOfPoses__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mrpt_msgs::msg::NetworkOfPoses *>(
...
static size_t _NetworkOfPoses__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_NetworkOfPoses(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _NetworkOfPoses__callbacks = {
  "mrpt_msgs::msg",
  "NetworkOfPoses",
...
static rosidl_message_type_support_t _NetworkOfPoses__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_NetworkOfPoses__callbacks,
...
{
  return &mrpt_msgs::msg::typesupport_fastrtps_cpp::_NetworkOfPoses__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mrpt_msgs, msg, NetworkOfPoses)() {
  return &mrpt_msgs::msg::typesupport_fastrtps_cpp::_NetworkOfPoses__handle;
}
