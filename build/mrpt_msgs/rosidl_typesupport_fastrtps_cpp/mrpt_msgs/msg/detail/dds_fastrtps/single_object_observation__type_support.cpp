...
#include "mrpt_msgs/msg/detail/single_object_observation__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mrpt_msgs::msg::SingleObjectObservation & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    cdr << ros_message.shape_variables;
  }
  // Member: id
  cdr << ros_message.id;
  return true;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mrpt_msgs::msg::SingleObjectObservation & ros_message)
{
  // Member: range
  cdr >> ros_message.range;
  ...
  size_t current_alignment)
{
  ...
  // Member: shape_variables
  {
    ...
    size_t item_size = sizeof(ros_message.shape_variables[0]);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mrpt_msgs::msg::SingleObjectObservation;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mrpt_msgs::msg::SingleObjectObservation *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mrpt_msgs::msg::SingleObjectObservation *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SingleObjectObservation__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mrpt_msgs::msg::SingleObjectObservation *>(
...
static size_t _SingleObjectObservation__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SingleObjectObservation(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SingleObjectObservation__callbacks = {
  "mrpt_msgs::msg",
...
static rosidl_message_type_support_t _SingleObjectObservation__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SingleObjectObservation__callbacks,
...
{
  return &mrpt_msgs::msg::typesupport_fastrtps_cpp::_SingleObjectObservation__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mrpt_msgs, msg, SingleObjectObservation)() {
  return &mrpt_msgs::msg::typesupport_fastrtps_cpp::_SingleObjectObservation__handle;
}
