...
#include "mrpt_msgs/msg/detail/waypoint_sequence__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mrpt_msgs::msg::WaypointSequence & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mrpt_msgs::msg::WaypointSequence & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: waypoints
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mrpt_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Waypoint(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = mrpt_msgs::msg::WaypointSequence;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mrpt_msgs::msg::WaypointSequence *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mrpt_msgs::msg::WaypointSequence *>(
    untyped_ros_message);
...
{
  return &mrpt_msgs::msg::typesupport_fastrtps_cpp::_WaypointSequence__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mrpt_msgs, msg, WaypointSequence)() {
  return &mrpt_msgs::msg::typesupport_fastrtps_cpp::_WaypointSequence__handle;
}
