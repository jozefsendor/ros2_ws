...
#include "mrpt_msgs/srv/detail/get_cm_graph__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mrpt_msgs::srv::GetCMGraph_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mrpt_msgs::srv::GetCMGraph_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mrpt_msgs::srv::GetCMGraph_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GetCMGraph_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mrpt_msgs::srv::GetCMGraph_Request *>(
...
static size_t _GetCMGraph_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetCMGraph_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GetCMGraph_Request__callbacks = {
  "mrpt_msgs::srv",
  "GetCMGraph_Request",
...
static rosidl_message_type_support_t _GetCMGraph_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetCMGraph_Request__callbacks,
...
{
  return &mrpt_msgs::srv::typesupport_fastrtps_cpp::_GetCMGraph_Request__handle;
}
...
{
bool cdr_serialize(
  const mrpt_msgs::msg::NetworkOfPoses &,
...
size_t get_serialized_size(
  ...
  size_t current_alignment);
size_t
max_serialized_size_NetworkOfPoses(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
  ...
  size_t current_alignment)
{
  ...
  // Member: cm_graph
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mrpt_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_NetworkOfPoses(
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = mrpt_msgs::srv::GetCMGraph_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mrpt_msgs::srv::GetCMGraph_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<mrpt_msgs::srv::GetCMGraph_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GetCMGraph_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mrpt_msgs::srv::GetCMGraph_Response *>(
...
static size_t _GetCMGraph_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetCMGraph_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GetCMGraph_Response__callbacks = {
  "mrpt_msgs::srv",
  "GetCMGraph_Response",
...
static rosidl_message_type_support_t _GetCMGraph_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetCMGraph_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &mrpt_msgs::srv::typesupport_fastrtps_cpp::_GetCMGraph_Response__handle;
}
...
static service_type_support_callbacks_t _GetCMGraph__callbacks = {
  "mrpt_msgs::srv",
  "GetCMGraph",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mrpt_msgs, srv, GetCMGraph_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mrpt_msgs, srv, GetCMGraph_Response)(),
...
static rosidl_service_type_support_t _GetCMGraph__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetCMGraph__callbacks,
...
{
  return &mrpt_msgs::srv::typesupport_fastrtps_cpp::_GetCMGraph__handle;
}
