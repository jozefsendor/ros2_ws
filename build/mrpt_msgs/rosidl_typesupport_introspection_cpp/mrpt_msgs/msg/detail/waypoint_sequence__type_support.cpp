...
{
  new (message_memory) mrpt_msgs::msg::WaypointSequence(_init);
}

void WaypointSequence_fini_function(void * message_memory)
{
  auto typed_message = static_cast<mrpt_msgs::msg::WaypointSequence *>(message_memory);
  typed_message->~WaypointSequence();
}

size_t size_function__WaypointSequence__waypoints(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<mrpt_msgs::msg::Waypoint> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<mrpt_msgs::msg::Waypoint> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<mrpt_msgs::msg::Waypoint> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const mrpt_msgs::msg::Waypoint *>(
    get_const_function__WaypointSequence__waypoints(untyped_member, index));
  auto & value = *reinterpret_cast<mrpt_msgs::msg::Waypoint *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<mrpt_msgs::msg::Waypoint *>(
    get_function__WaypointSequence__waypoints(untyped_member, index));
  const auto & value = *reinterpret_cast<const mrpt_msgs::msg::Waypoint *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember WaypointSequence_message_member_array[2] = {
  {
    "header",  // name
    ...
    offsetof(mrpt_msgs::msg::WaypointSequence, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<mrpt_msgs::msg::Waypoint>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(mrpt_msgs::msg::WaypointSequence, waypoints),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers WaypointSequence_message_members = {
  ...
  2,  // number of fields
  sizeof(mrpt_msgs::msg::WaypointSequence),
...
get_message_type_support_handle<mrpt_msgs::msg::WaypointSequence>()
{
  return &::mrpt_msgs::msg::rosidl_typesupport_introspection_cpp::WaypointSequence_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mrpt_msgs, msg, WaypointSequence)() {
  return &::mrpt_msgs::msg::rosidl_typesupport_introspection_cpp::WaypointSequence_message_type_support_handle;
}
