...
mrpt_nav_interfaces__action__NavigateGoal_Goal__init(mrpt_nav_interfaces__action__NavigateGoal_Goal * msg)
{
  ...
  if (!geometry_msgs__msg__PoseStamped__init(&msg->target)) {
    mrpt_nav_interfaces__action__NavigateGoal_Goal__fini(msg);
    return false;
  }
  return true;
}
...
mrpt_nav_interfaces__action__NavigateGoal_Goal__create()
{
  ...
  mrpt_nav_interfaces__action__NavigateGoal_Goal * msg = (mrpt_nav_interfaces__action__NavigateGoal_Goal *)allocator.allocate(sizeof(mrpt_nav_interfaces__action__NavigateGoal_Goal), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mrpt_nav_interfaces__action__NavigateGoal_Goal));
  bool success = mrpt_nav_interfaces__action__NavigateGoal_Goal__init(msg);
  if (!success) {
...
mrpt_nav_interfaces__action__NavigateGoal_Goal__Sequence__init(mrpt_nav_interfaces__action__NavigateGoal_Goal__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mrpt_nav_interfaces__action__NavigateGoal_Goal * data = NULL;

  if (size) {
    data = (mrpt_nav_interfaces__action__NavigateGoal_Goal *)allocator.zero_allocate(size, sizeof(mrpt_nav_interfaces__action__NavigateGoal_Goal), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mrpt_nav_interfaces__action__NavigateGoal_Goal__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        mrpt_nav_interfaces__action__NavigateGoal_Goal__fini(&data[i - 1]);
      }
...
mrpt_nav_interfaces__action__NavigateGoal_Goal__Sequence__fini(mrpt_nav_interfaces__action__NavigateGoal_Goal__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      mrpt_nav_interfaces__action__NavigateGoal_Goal__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mrpt_nav_interfaces__action__NavigateGoal_Goal__Sequence * array = (mrpt_nav_interfaces__action__NavigateGoal_Goal__Sequence *)allocator.allocate(sizeof(mrpt_nav_interfaces__action__NavigateGoal_Goal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mrpt_nav_interfaces__action__NavigateGoal_Goal__Sequence__init(array, size);
  if (!success) {
...
mrpt_nav_interfaces__action__NavigateGoal_Goal__Sequence__destroy(mrpt_nav_interfaces__action__NavigateGoal_Goal__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mrpt_nav_interfaces__action__NavigateGoal_Goal__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mrpt_nav_interfaces__action__NavigateGoal_Goal__Sequence__are_equal(const mrpt_nav_interfaces__action__NavigateGoal_Goal__Sequence * lhs, const mrpt_nav_interfaces__action__NavigateGoal_Goal__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mrpt_nav_interfaces__action__NavigateGoal_Goal__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mrpt_nav_interfaces__action__NavigateGoal_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mrpt_nav_interfaces__action__NavigateGoal_Goal);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mrpt_nav_interfaces__action__NavigateGoal_Goal * data =
      (mrpt_nav_interfaces__action__NavigateGoal_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mrpt_nav_interfaces__action__NavigateGoal_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mrpt_nav_interfaces__action__NavigateGoal_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!mrpt_nav_interfaces__action__NavigateGoal_Goal__copy(
...
mrpt_nav_interfaces__action__NavigateGoal_Result__init(mrpt_nav_interfaces__action__NavigateGoal_Result * msg)
{
  ...
  if (!mrpt_nav_interfaces__msg__NavigationFinalStatus__init(&msg->state)) {
    mrpt_nav_interfaces__action__NavigateGoal_Result__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mrpt_nav_interfaces__action__NavigateGoal_Result * msg = (mrpt_nav_interfaces__action__NavigateGoal_Result *)allocator.allocate(sizeof(mrpt_nav_interfaces__action__NavigateGoal_Result), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mrpt_nav_interfaces__action__NavigateGoal_Result));
  bool success = mrpt_nav_interfaces__action__NavigateGoal_Result__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
mrpt_nav_interfaces__action__NavigateGoal_Result__Sequence__init(mrpt_nav_interfaces__action__NavigateGoal_Result__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mrpt_nav_interfaces__action__NavigateGoal_Result * data = NULL;

  if (size) {
    data = (mrpt_nav_interfaces__action__NavigateGoal_Result *)allocator.zero_allocate(size, sizeof(mrpt_nav_interfaces__action__NavigateGoal_Result), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mrpt_nav_interfaces__action__NavigateGoal_Result__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        mrpt_nav_interfaces__action__NavigateGoal_Result__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
mrpt_nav_interfaces__action__NavigateGoal_Result__Sequence__fini(mrpt_nav_interfaces__action__NavigateGoal_Result__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      mrpt_nav_interfaces__action__NavigateGoal_Result__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mrpt_nav_interfaces__action__NavigateGoal_Result__Sequence * array = (mrpt_nav_interfaces__action__NavigateGoal_Result__Sequence *)allocator.allocate(sizeof(mrpt_nav_interfaces__action__NavigateGoal_Result__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mrpt_nav_interfaces__action__NavigateGoal_Result__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
mrpt_nav_interfaces__action__NavigateGoal_Result__Sequence__destroy(mrpt_nav_interfaces__action__NavigateGoal_Result__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mrpt_nav_interfaces__action__NavigateGoal_Result__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mrpt_nav_interfaces__action__NavigateGoal_Result__Sequence__are_equal(const mrpt_nav_interfaces__action__NavigateGoal_Result__Sequence * lhs, const mrpt_nav_interfaces__action__NavigateGoal_Result__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mrpt_nav_interfaces__action__NavigateGoal_Result__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mrpt_nav_interfaces__action__NavigateGoal_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mrpt_nav_interfaces__action__NavigateGoal_Result);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mrpt_nav_interfaces__action__NavigateGoal_Result * data =
      (mrpt_nav_interfaces__action__NavigateGoal_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mrpt_nav_interfaces__action__NavigateGoal_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mrpt_nav_interfaces__action__NavigateGoal_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!mrpt_nav_interfaces__action__NavigateGoal_Result__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
mrpt_nav_interfaces__action__NavigateGoal_Feedback__init(mrpt_nav_interfaces__action__NavigateGoal_Feedback * msg)
{
  ...
  if (!mrpt_nav_interfaces__msg__NavigationFeedback__init(&msg->state)) {
    mrpt_nav_interfaces__action__NavigateGoal_Feedback__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mrpt_nav_interfaces__action__NavigateGoal_Feedback * msg = (mrpt_nav_interfaces__action__NavigateGoal_Feedback *)allocator.allocate(sizeof(mrpt_nav_interfaces__action__NavigateGoal_Feedback), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mrpt_nav_interfaces__action__NavigateGoal_Feedback));
  bool success = mrpt_nav_interfaces__action__NavigateGoal_Feedback__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
mrpt_nav_interfaces__action__NavigateGoal_Feedback__Sequence__init(mrpt_nav_interfaces__action__NavigateGoal_Feedback__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mrpt_nav_interfaces__action__NavigateGoal_Feedback * data = NULL;

  if (size) {
    data = (mrpt_nav_interfaces__action__NavigateGoal_Feedback *)allocator.zero_allocate(size, sizeof(mrpt_nav_interfaces__action__NavigateGoal_Feedback), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mrpt_nav_interfaces__action__NavigateGoal_Feedback__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        mrpt_nav_interfaces__action__NavigateGoal_Feedback__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
mrpt_nav_interfaces__action__NavigateGoal_Feedback__Sequence__fini(mrpt_nav_interfaces__action__NavigateGoal_Feedback__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      mrpt_nav_interfaces__action__NavigateGoal_Feedback__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mrpt_nav_interfaces__action__NavigateGoal_Feedback__Sequence * array = (mrpt_nav_interfaces__action__NavigateGoal_Feedback__Sequence *)allocator.allocate(sizeof(mrpt_nav_interfaces__action__NavigateGoal_Feedback__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mrpt_nav_interfaces__action__NavigateGoal_Feedback__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
mrpt_nav_interfaces__action__NavigateGoal_Feedback__Sequence__destroy(mrpt_nav_interfaces__action__NavigateGoal_Feedback__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mrpt_nav_interfaces__action__NavigateGoal_Feedback__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mrpt_nav_interfaces__action__NavigateGoal_Feedback__Sequence__are_equal(const mrpt_nav_interfaces__action__NavigateGoal_Feedback__Sequence * lhs, const mrpt_nav_interfaces__action__NavigateGoal_Feedback__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mrpt_nav_interfaces__action__NavigateGoal_Feedback__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mrpt_nav_interfaces__action__NavigateGoal_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mrpt_nav_interfaces__action__NavigateGoal_Feedback);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mrpt_nav_interfaces__action__NavigateGoal_Feedback * data =
      (mrpt_nav_interfaces__action__NavigateGoal_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mrpt_nav_interfaces__action__NavigateGoal_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mrpt_nav_interfaces__action__NavigateGoal_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!mrpt_nav_interfaces__action__NavigateGoal_Feedback__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Request__init(mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Request * msg)
{
  ...
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Request__fini(msg);
    return false;
  }
  // goal
  if (!mrpt_nav_interfaces__action__NavigateGoal_Goal__init(&msg->goal)) {
    mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Request__fini(msg);
    return false;
  }
  return true;
...
mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Request__fini(mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Request * msg)
{
  ...
  // goal
  mrpt_nav_interfaces__action__NavigateGoal_Goal__fini(&msg->goal);
}
...
mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Request__are_equal(const mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Request * lhs, const mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Request * rhs)
{
  ...
  // goal
  if (!mrpt_nav_interfaces__action__NavigateGoal_Goal__are_equal(
      &(lhs->goal), &(rhs->goal)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Request * msg = (mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Request *)allocator.allocate(sizeof(mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Request));
  bool success = mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Request__Sequence__init(mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Request * data = NULL;

  if (size) {
    data = (mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Request *)allocator.zero_allocate(size, sizeof(mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Request__Sequence__fini(mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Request__Sequence * array = (mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Request__Sequence *)allocator.allocate(sizeof(mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Request__Sequence__destroy(mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Request__Sequence__are_equal(const mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Request__Sequence * lhs, const mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Request * data =
      (mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Response__init(mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Response * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Response * msg = (mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Response *)allocator.allocate(sizeof(mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Response));
  bool success = mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Response__Sequence__init(mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Response * data = NULL;

  if (size) {
    data = (mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Response *)allocator.zero_allocate(size, sizeof(mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Response__Sequence__fini(mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Response__Sequence * array = (mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Response__Sequence *)allocator.allocate(sizeof(mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Response__Sequence__destroy(mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Response__Sequence__are_equal(const mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Response__Sequence * lhs, const mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Response * data =
      (mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!mrpt_nav_interfaces__action__NavigateGoal_SendGoal_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
mrpt_nav_interfaces__action__NavigateGoal_GetResult_Request__init(mrpt_nav_interfaces__action__NavigateGoal_GetResult_Request * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    mrpt_nav_interfaces__action__NavigateGoal_GetResult_Request__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mrpt_nav_interfaces__action__NavigateGoal_GetResult_Request * msg = (mrpt_nav_interfaces__action__NavigateGoal_GetResult_Request *)allocator.allocate(sizeof(mrpt_nav_interfaces__action__NavigateGoal_GetResult_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mrpt_nav_interfaces__action__NavigateGoal_GetResult_Request));
  bool success = mrpt_nav_interfaces__action__NavigateGoal_GetResult_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
mrpt_nav_interfaces__action__NavigateGoal_GetResult_Request__Sequence__init(mrpt_nav_interfaces__action__NavigateGoal_GetResult_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mrpt_nav_interfaces__action__NavigateGoal_GetResult_Request * data = NULL;

  if (size) {
    data = (mrpt_nav_interfaces__action__NavigateGoal_GetResult_Request *)allocator.zero_allocate(size, sizeof(mrpt_nav_interfaces__action__NavigateGoal_GetResult_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mrpt_nav_interfaces__action__NavigateGoal_GetResult_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        mrpt_nav_interfaces__action__NavigateGoal_GetResult_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
mrpt_nav_interfaces__action__NavigateGoal_GetResult_Request__Sequence__fini(mrpt_nav_interfaces__action__NavigateGoal_GetResult_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      mrpt_nav_interfaces__action__NavigateGoal_GetResult_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mrpt_nav_interfaces__action__NavigateGoal_GetResult_Request__Sequence * array = (mrpt_nav_interfaces__action__NavigateGoal_GetResult_Request__Sequence *)allocator.allocate(sizeof(mrpt_nav_interfaces__action__NavigateGoal_GetResult_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mrpt_nav_interfaces__action__NavigateGoal_GetResult_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
mrpt_nav_interfaces__action__NavigateGoal_GetResult_Request__Sequence__destroy(mrpt_nav_interfaces__action__NavigateGoal_GetResult_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mrpt_nav_interfaces__action__NavigateGoal_GetResult_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mrpt_nav_interfaces__action__NavigateGoal_GetResult_Request__Sequence__are_equal(const mrpt_nav_interfaces__action__NavigateGoal_GetResult_Request__Sequence * lhs, const mrpt_nav_interfaces__action__NavigateGoal_GetResult_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mrpt_nav_interfaces__action__NavigateGoal_GetResult_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mrpt_nav_interfaces__action__NavigateGoal_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mrpt_nav_interfaces__action__NavigateGoal_GetResult_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mrpt_nav_interfaces__action__NavigateGoal_GetResult_Request * data =
      (mrpt_nav_interfaces__action__NavigateGoal_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mrpt_nav_interfaces__action__NavigateGoal_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mrpt_nav_interfaces__action__NavigateGoal_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!mrpt_nav_interfaces__action__NavigateGoal_GetResult_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
mrpt_nav_interfaces__action__NavigateGoal_GetResult_Response__init(mrpt_nav_interfaces__action__NavigateGoal_GetResult_Response * msg)
{
  ...
  // status
  // result
  if (!mrpt_nav_interfaces__action__NavigateGoal_Result__init(&msg->result)) {
    mrpt_nav_interfaces__action__NavigateGoal_GetResult_Response__fini(msg);
    return false;
  }
  return true;
}
...
mrpt_nav_interfaces__action__NavigateGoal_GetResult_Response__fini(mrpt_nav_interfaces__action__NavigateGoal_GetResult_Response * msg)
{
  ...
  // status
  // result
  mrpt_nav_interfaces__action__NavigateGoal_Result__fini(&msg->result);
}
...
mrpt_nav_interfaces__action__NavigateGoal_GetResult_Response__are_equal(const mrpt_nav_interfaces__action__NavigateGoal_GetResult_Response * lhs, const mrpt_nav_interfaces__action__NavigateGoal_GetResult_Response * rhs)
{
  ...
  // result
  if (!mrpt_nav_interfaces__action__NavigateGoal_Result__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mrpt_nav_interfaces__action__NavigateGoal_GetResult_Response * msg = (mrpt_nav_interfaces__action__NavigateGoal_GetResult_Response *)allocator.allocate(sizeof(mrpt_nav_interfaces__action__NavigateGoal_GetResult_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mrpt_nav_interfaces__action__NavigateGoal_GetResult_Response));
  bool success = mrpt_nav_interfaces__action__NavigateGoal_GetResult_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
mrpt_nav_interfaces__action__NavigateGoal_GetResult_Response__Sequence__init(mrpt_nav_interfaces__action__NavigateGoal_GetResult_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mrpt_nav_interfaces__action__NavigateGoal_GetResult_Response * data = NULL;

  if (size) {
    data = (mrpt_nav_interfaces__action__NavigateGoal_GetResult_Response *)allocator.zero_allocate(size, sizeof(mrpt_nav_interfaces__action__NavigateGoal_GetResult_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mrpt_nav_interfaces__action__NavigateGoal_GetResult_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        mrpt_nav_interfaces__action__NavigateGoal_GetResult_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
mrpt_nav_interfaces__action__NavigateGoal_GetResult_Response__Sequence__fini(mrpt_nav_interfaces__action__NavigateGoal_GetResult_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      mrpt_nav_interfaces__action__NavigateGoal_GetResult_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mrpt_nav_interfaces__action__NavigateGoal_GetResult_Response__Sequence * array = (mrpt_nav_interfaces__action__NavigateGoal_GetResult_Response__Sequence *)allocator.allocate(sizeof(mrpt_nav_interfaces__action__NavigateGoal_GetResult_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mrpt_nav_interfaces__action__NavigateGoal_GetResult_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
mrpt_nav_interfaces__action__NavigateGoal_GetResult_Response__Sequence__destroy(mrpt_nav_interfaces__action__NavigateGoal_GetResult_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mrpt_nav_interfaces__action__NavigateGoal_GetResult_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mrpt_nav_interfaces__action__NavigateGoal_GetResult_Response__Sequence__are_equal(const mrpt_nav_interfaces__action__NavigateGoal_GetResult_Response__Sequence * lhs, const mrpt_nav_interfaces__action__NavigateGoal_GetResult_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mrpt_nav_interfaces__action__NavigateGoal_GetResult_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mrpt_nav_interfaces__action__NavigateGoal_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mrpt_nav_interfaces__action__NavigateGoal_GetResult_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mrpt_nav_interfaces__action__NavigateGoal_GetResult_Response * data =
      (mrpt_nav_interfaces__action__NavigateGoal_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mrpt_nav_interfaces__action__NavigateGoal_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mrpt_nav_interfaces__action__NavigateGoal_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!mrpt_nav_interfaces__action__NavigateGoal_GetResult_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
mrpt_nav_interfaces__action__NavigateGoal_FeedbackMessage__init(mrpt_nav_interfaces__action__NavigateGoal_FeedbackMessage * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    mrpt_nav_interfaces__action__NavigateGoal_FeedbackMessage__fini(msg);
    return false;
  }
  // feedback
  if (!mrpt_nav_interfaces__action__NavigateGoal_Feedback__init(&msg->feedback)) {
    mrpt_nav_interfaces__action__NavigateGoal_FeedbackMessage__fini(msg);
    return false;
  }
  return true;
...
mrpt_nav_interfaces__action__NavigateGoal_FeedbackMessage__fini(mrpt_nav_interfaces__action__NavigateGoal_FeedbackMessage * msg)
{
  ...
  unique_identifier_msgs__msg__UUID__fini(&msg->goal_id);
  // feedback
  mrpt_nav_interfaces__action__NavigateGoal_Feedback__fini(&msg->feedback);
}
...
mrpt_nav_interfaces__action__NavigateGoal_FeedbackMessage__are_equal(const mrpt_nav_interfaces__action__NavigateGoal_FeedbackMessage * lhs, const mrpt_nav_interfaces__action__NavigateGoal_FeedbackMessage * rhs)
{
  ...
  // feedback
  if (!mrpt_nav_interfaces__action__NavigateGoal_Feedback__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mrpt_nav_interfaces__action__NavigateGoal_FeedbackMessage * msg = (mrpt_nav_interfaces__action__NavigateGoal_FeedbackMessage *)allocator.allocate(sizeof(mrpt_nav_interfaces__action__NavigateGoal_FeedbackMessage), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mrpt_nav_interfaces__action__NavigateGoal_FeedbackMessage));
  bool success = mrpt_nav_interfaces__action__NavigateGoal_FeedbackMessage__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
mrpt_nav_interfaces__action__NavigateGoal_FeedbackMessage__Sequence__init(mrpt_nav_interfaces__action__NavigateGoal_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mrpt_nav_interfaces__action__NavigateGoal_FeedbackMessage * data = NULL;

  if (size) {
    data = (mrpt_nav_interfaces__action__NavigateGoal_FeedbackMessage *)allocator.zero_allocate(size, sizeof(mrpt_nav_interfaces__action__NavigateGoal_FeedbackMessage), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mrpt_nav_interfaces__action__NavigateGoal_FeedbackMessage__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        mrpt_nav_interfaces__action__NavigateGoal_FeedbackMessage__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
mrpt_nav_interfaces__action__NavigateGoal_FeedbackMessage__Sequence__fini(mrpt_nav_interfaces__action__NavigateGoal_FeedbackMessage__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      mrpt_nav_interfaces__action__NavigateGoal_FeedbackMessage__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mrpt_nav_interfaces__action__NavigateGoal_FeedbackMessage__Sequence * array = (mrpt_nav_interfaces__action__NavigateGoal_FeedbackMessage__Sequence *)allocator.allocate(sizeof(mrpt_nav_interfaces__action__NavigateGoal_FeedbackMessage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mrpt_nav_interfaces__action__NavigateGoal_FeedbackMessage__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
mrpt_nav_interfaces__action__NavigateGoal_FeedbackMessage__Sequence__destroy(mrpt_nav_interfaces__action__NavigateGoal_FeedbackMessage__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mrpt_nav_interfaces__action__NavigateGoal_FeedbackMessage__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mrpt_nav_interfaces__action__NavigateGoal_FeedbackMessage__Sequence__are_equal(const mrpt_nav_interfaces__action__NavigateGoal_FeedbackMessage__Sequence * lhs, const mrpt_nav_interfaces__action__NavigateGoal_FeedbackMessage__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mrpt_nav_interfaces__action__NavigateGoal_FeedbackMessage__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mrpt_nav_interfaces__action__NavigateGoal_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mrpt_nav_interfaces__action__NavigateGoal_FeedbackMessage);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mrpt_nav_interfaces__action__NavigateGoal_FeedbackMessage * data =
      (mrpt_nav_interfaces__action__NavigateGoal_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mrpt_nav_interfaces__action__NavigateGoal_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mrpt_nav_interfaces__action__NavigateGoal_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!mrpt_nav_interfaces__action__NavigateGoal_FeedbackMessage__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
