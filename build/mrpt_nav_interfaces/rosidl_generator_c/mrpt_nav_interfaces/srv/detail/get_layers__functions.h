...
#ifndef MRPT_NAV_INTERFACES__SRV__DETAIL__GET_LAYERS__FUNCTIONS_H_
#define MRPT_NAV_INTERFACES__SRV__DETAIL__GET_LAYERS__FUNCTIONS_H_
...
/// Initialize srv/GetLayers message.
/**
...
/// Finalize srv/GetLayers message.
/**
...
/// Create srv/GetLayers message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * mrpt_nav_interfaces__srv__GetLayers_Request__init().
...
/// Destroy srv/GetLayers message.
/**
 * It calls
 * mrpt_nav_interfaces__srv__GetLayers_Request__fini()
...
/// Check for srv/GetLayers message equality.
/**
...
/// Initialize array of srv/GetLayers messages.
/**
...
/// Finalize array of srv/GetLayers messages.
/**
 * It calls
 * mrpt_nav_interfaces__srv__GetLayers_Request__fini()
...
/// Create array of srv/GetLayers messages.
/**
 * It allocates the memory for the array and calls
 * mrpt_nav_interfaces__srv__GetLayers_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/GetLayers messages.
/**
 * It calls
 * mrpt_nav_interfaces__srv__GetLayers_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/GetLayers message array equality.
/**
...
/// Copy an array of srv/GetLayers messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * mrpt_nav_interfaces__srv__GetLayers_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mrpt_nav_interfaces
...
/**
 * It calls
 * mrpt_nav_interfaces__srv__GetLayers_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_mrpt_nav_interfaces
...
/**
 * It allocates the memory for the array and calls
 * mrpt_nav_interfaces__srv__GetLayers_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mrpt_nav_interfaces
...
/**
 * It calls
 * mrpt_nav_interfaces__srv__GetLayers_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MRPT_NAV_INTERFACES__SRV__DETAIL__GET_LAYERS__FUNCTIONS_H_
