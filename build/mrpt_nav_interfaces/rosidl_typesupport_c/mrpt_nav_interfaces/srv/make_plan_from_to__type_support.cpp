...
static const _MakePlanFromTo_Request_type_support_symbol_names_t _MakePlanFromTo_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mrpt_nav_interfaces, srv, MakePlanFromTo_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mrpt_nav_interfaces, srv, MakePlanFromTo_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mrpt_nav_interfaces, srv, MakePlanFromTo_Request)() {
  return &::mrpt_nav_interfaces::srv::rosidl_typesupport_c::MakePlanFromTo_Request_message_type_support_handle;
}
...
static const _MakePlanFromTo_Response_type_support_symbol_names_t _MakePlanFromTo_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mrpt_nav_interfaces, srv, MakePlanFromTo_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mrpt_nav_interfaces, srv, MakePlanFromTo_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mrpt_nav_interfaces, srv, MakePlanFromTo_Response)() {
  return &::mrpt_nav_interfaces::srv::rosidl_typesupport_c::MakePlanFromTo_Response_message_type_support_handle;
}
...
static const _MakePlanFromTo_type_support_symbol_names_t _MakePlanFromTo_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mrpt_nav_interfaces, srv, MakePlanFromTo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mrpt_nav_interfaces, srv, MakePlanFromTo)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, mrpt_nav_interfaces, srv, MakePlanFromTo)() {
  return &::mrpt_nav_interfaces::srv::rosidl_typesupport_c::MakePlanFromTo_service_type_support_handle;
}
