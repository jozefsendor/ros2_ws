...
static const _GeoreferencingMetadata_type_support_symbol_names_t _GeoreferencingMetadata_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mrpt_nav_interfaces, msg, GeoreferencingMetadata)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mrpt_nav_interfaces, msg, GeoreferencingMetadata)),
  }
};
...
{
  return &::mrpt_nav_interfaces::msg::rosidl_typesupport_cpp::GeoreferencingMetadata_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mrpt_nav_interfaces, msg, GeoreferencingMetadata)() {
  return get_message_type_support_handle<mrpt_nav_interfaces::msg::GeoreferencingMetadata>();
}
