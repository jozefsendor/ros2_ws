...
#include "mrpt_nav_interfaces/msg/detail/navigation_feedback__rosidl_typesupport_fastrtps_c.h"
...
using _NavigationFeedback__ros_msg_type = mrpt_nav_interfaces__msg__NavigationFeedback;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _NavigationFeedback__ros_msg_type * ros_message = static_cast<const _NavigationFeedback__ros_msg_type *>(untyped_ros_message);
  // Field name: total_waypoints
  {
    cdr << ros_message->total_waypoints;
  }

  // Field name: reached_waypoints
  {
  ...
  void * untyped_ros_message)
{
  ...
  _NavigationFeedback__ros_msg_type * ros_message = static_cast<_NavigationFeedback__ros_msg_type *>(untyped_ros_message);
  // Field name: total_waypoints
  {
    cdr >> ros_message->total_waypoints;
  }
...
static uint32_t _NavigationFeedback__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mrpt_nav_interfaces__msg__NavigationFeedback(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mrpt_nav_interfaces__msg__NavigationFeedback;
    is_plain =
      (
...
static size_t _NavigationFeedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mrpt_nav_interfaces__msg__NavigationFeedback(
...
static message_type_support_callbacks_t __callbacks_NavigationFeedback = {
...
static rosidl_message_type_support_t _NavigationFeedback__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_NavigationFeedback,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mrpt_nav_interfaces, msg, NavigationFeedback)() {
  return &_NavigationFeedback__type_support;
}
