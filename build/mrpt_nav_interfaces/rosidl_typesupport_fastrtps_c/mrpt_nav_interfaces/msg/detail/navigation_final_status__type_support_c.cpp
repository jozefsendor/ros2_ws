...
#include "mrpt_nav_interfaces/msg/detail/navigation_final_status__rosidl_typesupport_fastrtps_c.h"
...
using _NavigationFinalStatus__ros_msg_type = mrpt_nav_interfaces__msg__NavigationFinalStatus;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _NavigationFinalStatus__ros_msg_type * ros_message = static_cast<const _NavigationFinalStatus__ros_msg_type *>(untyped_ros_message);
  // Field name: navigation_status
  {
  ...
  void * untyped_ros_message)
{
  ...
  _NavigationFinalStatus__ros_msg_type * ros_message = static_cast<_NavigationFinalStatus__ros_msg_type *>(untyped_ros_message);
  // Field name: navigation_status
  {
    cdr >> ros_message->navigation_status;
  }
...
static uint32_t _NavigationFinalStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mrpt_nav_interfaces__msg__NavigationFinalStatus(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mrpt_nav_interfaces__msg__NavigationFinalStatus;
    is_plain =
      (
...
static size_t _NavigationFinalStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mrpt_nav_interfaces__msg__NavigationFinalStatus(
...
static message_type_support_callbacks_t __callbacks_NavigationFinalStatus = {
...
static rosidl_message_type_support_t _NavigationFinalStatus__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_NavigationFinalStatus,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mrpt_nav_interfaces, msg, NavigationFinalStatus)() {
  return &_NavigationFinalStatus__type_support;
}
