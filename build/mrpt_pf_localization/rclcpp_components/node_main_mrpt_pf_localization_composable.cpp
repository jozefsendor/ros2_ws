...
#define NODE_MAIN_LOGGER_NAME "mrpt_pf_localization_composable"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libmrpt_pf_localization_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<PFLocalizationNode>";
