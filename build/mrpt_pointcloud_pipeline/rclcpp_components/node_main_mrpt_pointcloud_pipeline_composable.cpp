...
#define NODE_MAIN_LOGGER_NAME "mrpt_pointcloud_pipeline_composable"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libmrpt_pointcloud_pipeline_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<LocalObstaclesNode>";
